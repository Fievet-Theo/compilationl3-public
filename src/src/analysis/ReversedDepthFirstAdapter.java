...
public class ReversedDepthFirstAdapter extends AnalysisAdapter
{
    ...
    public void inAAff(AAff node)
    {
        defaultIn(node);
    }

    public void outAAff(AAff node)
    {
        defaultOut(node);
    }
    ...
    public void inAIbloc1(AIbloc1 node)
    {
        defaultIn(node);
    }

    public void outAIbloc1(AIbloc1 node)
    {
        defaultOut(node);
    }
    ...
    public void inAIecr(AIecr node)
    {
        defaultIn(node);
    }

    public void outAIecr(AIecr node)
    {
        defaultOut(node);
    }
